...
Position exit logic:
  - Positions are ONLY closed when TP, SL, or trailing stop is hit.
  - No reversal-based exits. Strategy signals only open new positions.
  - TP/SL prices are calculated by the strategy using ATR and passed in.
